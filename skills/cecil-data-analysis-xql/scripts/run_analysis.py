...
def _build_context(client: cecil.Client, subscription_id: str, table_name_override: str | None = None):
    ...
    ctx = xql.XarrayContext().from_dataset(tbl, ds)
    ...
    return ds, ctx, tbl, registered_refs
...
def main() -> int:
    ...
    client = cecil.Client()
    _, ctx, tbl, refs = _build_context(client, args.subscription, args.table_name)
